...
import {Event, EventType, Product, ProductQuantityAppliesTo, ProductType} from "../../../types.ts";
import {ActionIcon, Menu, NumberInput, Switch, TextInput, UnstyledButton} from "@mantine/core";
import {IconCheck, IconChevronDown, IconTrash, IconTrashOff} from "@tabler/icons-react";
