...
import {VatValidationStatus} from '../../../../../api/vat.client';
...
export const VatSettingsForm = ({organizerId, onSuccess}: VatSettingsFormProps) => {
    ...
    const upsertMutation = useUpsertOrganizerVatSetting(organizerId);
