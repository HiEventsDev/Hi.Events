...
import { Badge, Button, Group, Title, Box } from "@mantine/core"
import { IconPlus } from "@tabler/icons-react";
import { Card } from "../../../../common/Card";
import { useDisclosure } from "@mantine/hooks";
import { OrganizerWebhookTable } from "../../../../common/OrganizerWebhookTable";
import { useGetOrganizerWebhooks } from "../../../../../queries/useGetOrganizerWebhooks.ts";
...
export const WebhookSettings = () => {
    ...
    return (
        <Box>
            <Title order={2} mb="md">{t`Webhooks`}</Title>
            <Card>
