...
namespace HiEvents\Services\Common\Ticket;
...
use HiEvents\Services\Common\Tax\TaxAndFeeCalculationService;
...
readonly class TicketFilterService
{
    ...
    private function shouldTicketBeDiscounted(?PromoCodeDomainObject $promoCode, TicketDomainObject $ticket): bool
    {
        ...
        return $promoCode && $promoCode->isDiscountCode() && $promoCode->appliesToTicket($ticket);
    }
}
