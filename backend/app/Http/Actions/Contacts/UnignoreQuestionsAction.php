...
use HiEvents\Services\Application\Handlers\Contact\UnignoreQuestionsHandler;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;

class UnignoreQuestionsAction extends BaseAction
{
    public function __construct(
        private readonly UnignoreQuestionsHandler $handler,
    ) {}
