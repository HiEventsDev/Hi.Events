...
$router->middleware(['auth:api'])->group(
    function (Router $router): void {
        ...
        $router->get('/accounts/{account_id}/contacts/backfill/conflicts', \HiEvents\Http\Actions\Contacts\GetConflictsBackfillAction::class);
        $router->post('/accounts/{account_id}/contacts/backfill/ignore-attendees', \HiEvents\Http\Actions\Contacts\IgnoreAttendeesAction::class);
        $router->post('/accounts/{account_id}/contacts/backfill/unignore-attendees', \HiEvents\Http\Actions\Contacts\UnignoreAttendeesAction::class);
        $router->post('/accounts/{account_id}/contacts/backfill/add-contacts', \HiEvents\Http\Actions\Contacts\AddContactsFromAttendeesAction::class);
        $router->post('/accounts/{account_id}/contacts/backfill/reuse-questions', \HiEvents\Http\Actions\Contacts\ReuseQuestionsAction::class);
        ...
        $router->get('/accounts/{account_id}/contact-attribute-definitions', \HiEvents\Http\Actions\ContactAttributeDefinitions\GetContactAttributeDefinitionsAction::class);
