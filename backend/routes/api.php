...
use HiEvents\Http\Actions\Orders\Payment\Razorpay\RazorpayPaymentCallbackActionPublic;
...
$router->prefix('/public')->group(
    function (Router $router): void {
        ...
        $router->post('/events/{event_id}/order/{order_short_id}/razorpay/callback', RazorpayPaymentCallbackActionPublic::class);
